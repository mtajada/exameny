...
export const TransformationRenderer: React.FC<TransformationRendererProps> = ({
  question,
  questionIndex,
  userAnswer,
  isActive,
  ...
  const getGapClassName = () => {
    const baseClass = 'gap-placeholder inline-block px-3 py-2 mx-1 rounded-md border-2 cursor-pointer transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 min-w-[120px] text-center';
    const status = getGapStatus();
    switch (status) {
      case 'active':
        return `${baseClass} border-blue-600 bg-blue-50 text-blue-900 ring-2 ring-blue-200 border-solid`;
      case 'answered':
      ...
      default:
        return `${baseClass} border-gray-400 hover:border-blue-400 hover:bg-blue-50 text-gray-600 border-dashed`;
    }
  };
